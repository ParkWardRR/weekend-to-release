...
function analyzeContributor(files) {
  ...
  const methodicalSignals = ['charter', 'test-driven', 'tdd', 'red green', 'atomic commit', 'eslint', 'prettier', '.cursorrules', 'npm test'];
  ...
  const phases = [];
  const specSignals = ['charter', 'plan', 'requirements', 'jira', 'product brief', 'idea'];
  ...
  if (specSignals.some(s => lower.includes(s))) phases.push('charter');
