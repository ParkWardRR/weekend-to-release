import{_ as l,o as a,c as s,ae as o}from"./chunks/framework._S7TKm7w.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{"layout":"home","hero":{"name":"Weekend-to-Release","text":"The Agentic SDLC","tagline":"From Blank Page to \\"It Ships\\" — Tailored for Humans & AI.","actions":[{"theme":"brand","text":"Start Phase 1","link":"/curriculum/ai_skills/01_the_ai_stack"},{"theme":"alt","text":"View Cheatsheets","link":"/cheatsheet"}]},"features":[{"icon":"🧠","title":"Phase 1: It Runs","details":"Master the AI stack, prompting, and the build loop."},{"icon":"🏗️","title":"Phase 2: Build","details":"Filter ideas and scope your MVP."},{"icon":"🚀","title":"Phase 3: It Ships","details":"Testing, distribution, and launch."}]},"headers":[],"relativePath":"index.md","filePath":"index.md"}'),u={name:"index.md"};function n(g,t,e,i,c,d){return a(),s("div",null,[...t[0]||(t[0]=[o(`<div class="container"><h2 id="curriculum">📚 The Curriculum</h2><p>Choose your path. View as full course modules or quick cheatsheets.</p><pre><code>&lt;div class=&quot;phase-section&quot;&gt;
...
&lt;/div&gt;
&lt;/div&gt;
</code></pre><h2 id="human-devs">👤 Human Developers (Criteria Packages)</h2><p>See how real developers customized their learning path based on their chaos.</p><ul><li><a href="/curriculum/user_ai_example_1.md"><strong>@ai_example_1</strong></a> (4 modules recommended)</li><li><a href="/curriculum/user_ai_example_2.md"><strong>@ai_example_2</strong></a> (0 modules recommended)</li><li><a href="/curriculum/user_alex.md"><strong>@alex</strong></a> (4 modules recommended)</li><li><a href="/curriculum/user_antigravity.md"><strong>@antigravity</strong></a> (0 modules recommended)</li><li><a href="/curriculum/user_claire.md"><strong>@claire</strong></a> (0 modules recommended)</li></ul></div>`,1)])])}const p=l(u,[["render",n]]);export{q as __pageData,p as default};
