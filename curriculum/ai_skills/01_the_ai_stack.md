...
### 📝 The Editor: VS Code / Cursor / Zed
Your view into what the AI is doing. Works on Mac, Windows, and Linux.
...
| :--- | :--- |
| You write the function. | You write the *charter* for the function. |
