...
# 02. Prompt Engineering: Writing the charter

> **Goal:** If you give a vague charter, you get vague code. Garbage in, garbage out.
...
- [ ] Always charter the tech stack (language, frameworks).
- [ ] Always charter the input and output format.
