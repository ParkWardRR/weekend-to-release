...
features:
  - icon: "🧠"
    ...
    details: AI writes the code. You define the charter, review the output, and make the decisions.
  - icon: "🔄"
    title: "charter-Build-Test-Ship"
...
flowchart LR
  ...
  charter --> BUILD --> TEST --> SHIP --> SUPPORT
  SUPPORT -.->|"next cycle"| charter

  style charter fill:#e8f4fd,stroke:#4a9eca,color:#1a1a1a
...
<div class="phase-block phase-charter">
  <div class="phase-label">Phase 1</div>
  <h3>charter — Define What to Build</h3>
...
<div class="phase-block phase-build">
  ...
  <p>The charter-Agent-Review loop. AI generates code in focused chunks, you review and steer. Context management keeps things on track.</p>

```mermaid
flowchart LR
  S["charter / Prompt"] --> A["AI Agent\nwrites code"]
  A --> R{"You Review"}
...
flowchart LR
  subgraph PDLC["Development Lifecycle"]
    direction LR
    S["charter"] --> B["Build"] --> T["Test"] --> H["Ship"] --> U["Support"]
  end
...
<div class="pro-grid">
      ...
      <div class="pro-card">
        <a href="/learn/ai_example_1/">
          ...
          <div class="pro-phases"><span class="phase-dot phase-charter" title="charter">charter</span><span class="phase-dot phase-build" title="Build">Build</span><span class="phase-dot phase-test" title="Test">Test</span></div>
      ...
      <div class="pro-card">
        <a href="/learn/ai_example_2/">
          ...
          <div class="pro-phases"><span class="phase-dot phase-charter" title="charter">charter</span><span class="phase-dot phase-build" title="Build">Build</span><span class="phase-dot phase-test" title="Test">Test</span><span class="phase-dot phase-ship" title="Ship">Ship</span></div>
      ...
      <div class="pro-card">
        <a href="/learn/alex/">
          ...
          <div class="pro-phases"><span class="phase-dot phase-build" title="Build">Build</span><span class="phase-dot phase-test" title="Test">Test</span><span class="phase-dot phase-ship" title="Ship">Ship</span></div>
          <div class="pro-tools"><span class="tag tag-tool">ChatGPT</span><span class="tag tag-tool">Copilot</span><span class="tag tag-tool">VS Code</span><span class="tag tag-tool">Python</span></div>
          <div class="pro-links">
            <a href="/learn/alex/course" class="pro-link">Course</a>
            <a href="/learn/alex/cheatsheet" class="pro-link">Cheatsheet</a>
          </div>
        </a>
      </div>
      ...
      <div class="pro-card">
        <a href="/learn/antigravity/">
          ...
          <div class="pro-phases"><span class="phase-dot phase-charter" title="charter">charter</span><span class="phase-dot phase-build" title="Build">Build</span><span class="phase-dot phase-test" title="Test">Test</span></div>
          <div class="pro-tools"><span class="tag tag-tool">DeepSeek</span><span class="tag tag-tool">Cursor</span><span class="tag tag-tool">Cline</span><span class="tag tag-tool">VS Code</span></div>
          <div class="pro-links">
            <a href="/learn/antigravity/course" class="pro-link">Course</a>
            <a href="/learn/antigravity/cheatsheet" class="pro-link">Cheatsheet</a>
          </div>
        </a>
      </div>
      ...
      <div class="pro-card">
        <a href="/learn/claire/">
          ...
          <div class="pro-phases"><span class="phase-dot phase-charter" title="charter">charter</span><span class="phase-dot phase-build" title="Build">Build</span><span class="phase-dot phase-test" title="Test">Test</span></div>
          <div class="pro-tools"><span class="tag tag-tool">VS Code</span><span class="tag tag-tool">Jest</span><span class="tag tag-tool">ESLint</span><span class="tag tag-tool">Jira</span></div>
          <div class="pro-links">
            <a href="/learn/claire/course" class="pro-link">Course</a>
            <a href="/learn/claire/cheatsheet" class="pro-link">Cheatsheet</a>
          </div>
        </a>
      </div>
</div>
...
.phase-charter { border-left: 4px solid #4a9eca; }
.phase-charter .phase-label { background: #e8f4fd; color: #4a9eca; }
...
.phase-charter { background: #e8f4fd; color: #4a9eca; }
