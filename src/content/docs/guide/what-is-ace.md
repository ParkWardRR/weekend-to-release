...
Every project has a `.charter/` directory containing structured charters. These define what the software does, who it is for, and what success looks like. AI agents read these charters. Reviewers check code against these charters. The charters are never generated from code -- code is generated from charters.
