...
This is exactly what specifications describe — making Test-First a natural extension of SDD.
...
SDD recognizes three test categories, aligned with **Article IV (Integration Testing)**:
...
Integration tests are the most valuable in SDD because they verify **contracts** — the agreements between components defined in the Plan phase.
...
1. **Contract tests** — Does the API return what the spec says?
