...
description: Charter-Orchestrated Engineering with GitHub charter Kit
template: splash
hero:
  tagline: "Stop guessing. Start specifying. A practical guide to building software with AI agents using GitHub charter Kit's charter-driven methodology."
  actions:
    - text: Start Learning
      link: /weekend-to-release/guide/what-is-ACE/
      icon: right-arrow
      variant: primary
    - text: View charter Kit
      link: https://github.com/github/charter-kit
      icon: external
---
...
Head to [What is ACE?](/weekend-to-release/guide/what-is-ACE/) to understand the methodology, or jump to [Getting Started](/weekend-to-release/guide/getting-started/) to install charter Kit now.
