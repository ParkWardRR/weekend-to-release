...
description: Check alignment across your spec, plan, and tasks.
---

The `/speckit.analyze` command performs a read-only analysis of your specification artifacts. It finds gaps, duplications, and inconsistencies before implementation begins.
...
Run `/speckit.analyze` after generating tasks and before starting implementation. It is your last chance to catch problems cheaply. After implementation begins, fixes cost 10x more.
