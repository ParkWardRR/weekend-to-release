...
The `/speckit.analyze` command performs a read-only analysis of your charter artifacts. It finds gaps, duplications, and inconsistencies before implementation begins.
