...
User stories define what users can do with your software. In SDD, every story is prioritized, independently testable, and has explicit acceptance criteria.
