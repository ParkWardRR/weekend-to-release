...
|-------|----------------------|------------|
| Claude Code | `/auro.*` commands | `.claude/CLAUDE.md` |
...
Auro auto-detects your agent and generates the right file format.

## The 15-Minute Advantage

Traditional documentation takes hours. ACE takes about 15 minutes:

- 5 min: `/auro.charter` -- write the charter
- 5 min: `/auro.plan` -- generate the plan
- 5 min: `/auro.tasks` -- break into tasks
