...
Spec Kit generates an agent-specific guidance file that provides persistent context about your project. This file is automatically updated when you run `/speckit.plan`.
