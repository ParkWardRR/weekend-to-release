---
title: Spec Template
description: The template used by /speckit.specify to generate feature specifications.
---

The spec template structures every feature specification into consistent sections.
