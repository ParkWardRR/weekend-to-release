...
Every entry traces back to a spec requirement or a constitutional article. If the spec does not mention performance, the performance field says so explicitly rather than inventing a target.
