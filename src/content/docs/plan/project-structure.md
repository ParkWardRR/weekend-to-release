...
The plan defines two trees: a documentation tree (spec artifacts) and a source tree (code).
...
Spec Kit supports three layouts. Pick the one that matches your project.
