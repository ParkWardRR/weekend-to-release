...
## charter.md (copy/paste to kick-start an agent)
```markdown
# Weekend-to-Release — charter (Agent Kickstart)
...
If you tell me the example product (one sentence), I’ll revise `charter.md` so the agent can write with concrete commands, configs, and screenshots placeholders—without turning it into a wall of text.
